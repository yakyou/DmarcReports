...
<table>
	<tr>
		<th colspan="3" rowspan="2">report_metadata</th>
...
while ($report = $reports->fetchArray()) {
	...
	echo '<td>' . date("m-d H:i", $report['report_metadata_date_range_begin']) . ' to ' . date("m-d H:i", $report['report_metadata_date_range_end']) . '</td>';
